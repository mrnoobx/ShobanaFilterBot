...
API_ID = int(environ.get('API_ID', '22419004'))
API_HASH = environ.get('API_HASH', '34982b52c4a83c2af3ce8f4fe12fe4e1')
BOT_TOKEN = environ.get('BOT_TOKEN', '8892068525:AAFgsvGZt8eYoA4iqsBBeQGm3qauFYdtCc0')
...
PICS = (environ.get('PICS', 'https://graph.org/file/ceba7e4c839a3a20c0ed6-0c3070a760489cb680.jpg https://graph.org/file/e54ea154e99119547d626-4df2f3a10e68c568ff.jpg')).split()

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8565045255').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003728398597').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mrnoobx:DAZCdTczVWyECi04@cluster0.sedgwxy.mongodb.net/?retryWrites=true&w=majority")
...
FILE_CHANNEL_SENDING_MODE = is_enabled(environ.get('FILE_CHANNEL_SENDING_MODE', 'Flase'), False)
FILE_AUTO_DELETE_SECONDS = int(environ.get('FILE_AUTO_DELETE_SECONDS', 60))  # Default: 1 minute

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003728398597'))
